            ...
            if (type == null) { // null == available
                ...
                if(notifications!=null&&notifications.size()>0){
                	for(Notification notification:notifications){
                		notificationManager.sendNotifcation(notification, user.getUsername());
//                		notificationManager.sendNotifcationToUser(notification.getApiKey(), session.getUsername(), notification.getTitle(), notification.getMessage(), notification.getUri());
