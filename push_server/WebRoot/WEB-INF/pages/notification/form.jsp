...
<tr>
	<td>Title:</td>
	<td><input type="text" id="title" name="title" value="push title" style="width:380px;" /></td>
</tr>
<tr>
	<td>Message:</td>
	<td><textarea id="message" name="message" style="width:380px; height:80px;" >push content</textarea></td>
</tr>
<%--
<tr>
	<td>Ticker:</td>
...
<tr>
	...
	<td><input type="file" id="uri" name="uri" value="" style="width:380px;" />
	    <br/><span style="font-size:0.8em">upload file</span>
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
