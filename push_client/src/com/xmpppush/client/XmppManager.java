...
public class XmppManager {
    ...
    private static final String LOGTAG = CommonUtil.makeLogTag(XmppManager.class);
    ...
    public XmppManager(NotificationService notificationService) {
        ...
        handler = new Handler();
        taskList = new LinkedList<Runnable>();//new ArrayList<Runnable>();
        ...
        public void run() {
            ...
            if (!xmppManager.isAuthenticated()) {
                ...
                try {
                    ...
                    connection.addPacketListener(packetListener, packetFilter);
                    connection.startHeartBeat();//start heart beat
